...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 10 mai 2020 à 14:33
...
INSERT INTO `user_document` (`user_id`, `document_id`, `last_page_number`, `last_read_date`) VALUES
(1, 3, 3, '2020-05-10 10:20:39'),
(1, 4, 7, '2020-05-10 14:33:15'),
(1, 12, 6, '2020-05-10 09:51:08');
...
ALTER TABLE `user_document`
  ADD CONSTRAINT `fk_user_document_document` FOREIGN KEY (`document_id`) REFERENCES `document` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_user_document_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
COMMIT;
